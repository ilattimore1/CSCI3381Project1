...
public interface PatientCollectionADT {
	...
	// Return the patient with the given id.  Return void if the id does not exist in the collection
	...
	// Return a String representation of the collection.  Only include the 3697th and 3258th values in that order. 
